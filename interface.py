...
def choice():
    ...
    while (flag.lower() == 'да'):
        ...
        if not valid:
            creating()
        choice_action = input(
            'Введите \'Запись\', если хотите записать новые данные, \'Изменение\' для изменения данных, \'Поиск\' для поиска абонента и \'Просмотр\', если хотите просмотреть справочник в консоли: ')
